...
#./upload_containers.sh -l 192.168.24.1:8787 -r satellite.englab.juniper.net:5443 -t master-139-rhel -c http://satellite.englab.juniper.net/pub/satellite.englab.juniper.net.cert
